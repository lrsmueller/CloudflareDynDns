...
{
	public abstract class RefreshObjectBase
	{
		protected ILogger _logger;
		public RefreshObjectBase(HttpRequest request, ILogger logger)
		{
			_logger = logger;
			_request = request;
			_logger.LogInformation($"Creating {nameof(RefreshObjectBase)} Object");
